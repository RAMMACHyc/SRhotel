...
<div class=" mb-8 py-8 px-8 max-w-xl mx-auto bg-gradient-to-r dark:bg-gray-700 rounded-xl shadow-lg  space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
    <div class="text-center space-y-2 sm:text-left">
        ...
        <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-600 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-600 dark:focus:border-purple-500 "onchange="showSelect(this)">
            <!-- <option selected>_____</option> -->
            <option value="1">Lit single</option>
            <option value="2">double</option>
            <option value="3" id="suite">suite</option>

        </select>
        <select id="inpu" class="bg-purple-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-600 focus:border-purple-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-600 dark:focus:border-purple-500 hidden ">
            <!-- <option selected>suites</option> -->
            <option value="4">Standard suite rooms</option>
            <option value="5">Junior</option>
            <option value="6">Presidential suite</option>
            <option value="7">Penthouse suites</option>
            <option value="8">Honeymoon suites</option>
            <option value="9">Bridal suites</option>
            ...
            <div>
                ...
                <div class="w-72 flex flex-col bg-slate-800  shadow-slate-800/50 dark:bg-gray-700 rounded-lg shadow-lg m-4 p-4">
                    <div name="Number" class="text-2xl font-bold dark:text-white mb-4"><span class="number"><?php echo $room['number']; ?></span>
                        <?php if (isset($_SESSION['logged']) && $_SESSION['logged'] === true) { ?>
                            <form method="POST" class="ms-1" action="update">
                                <input type="hidden" name="id" value="<?php echo $room['id']; ?>">

                                <button class="inline-flex items-center justify-center w-10 h-10 ml-10 text-gray-50 transition-colors duration-150 dark:bg-gray-700 rounded-full focus:shadow-outline hover:bg-gray-800">
                                    <svg class="w-4 h-4 fill-current" viewBox="0 0 20 20">
